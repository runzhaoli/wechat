				...
				<tr>
					<td>
						<c:if test="${ not empty entity.img }">
							<img alt="logo" id="imgsrc" src="${entity.img }" width="24px" height="24px;">
						</c:if>
					</td>
					<td>${entity.title }</td>
					<td>${entity.description }</td>
					<td><dic:text group="<%=ContextConstants.GROUP.ARTICLE_TYPE %>" value="${entity.type }"></dic:text></td>
					<td><fmt:formatDate value="${entity.create }" pattern="yyyy-MM-dd"/></td>
					<td>
