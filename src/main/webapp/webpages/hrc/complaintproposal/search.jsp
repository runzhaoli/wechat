		...
		<table class="table table-hover ">
			...
			<c:forEach var="entity" items="${page.content }">
				<tr>
					...
					<td><dic:text group="<%=ContextConstants.GROUP.COMPLAINT_PROPOSAL_TYPE %>" value="${entity.type }" showcode="false"></dic:text></td>
<%-- 					<td title="${entity.description }">${entity.desc }</td> --%>
					<td style="white-space: normal; word-break: break-word; text-align: left;">${entity.description }</td>
