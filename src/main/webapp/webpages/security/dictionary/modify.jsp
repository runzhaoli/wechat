	...
	<form id="modifyform" action="" method="post">
		...
		<div id="task">
			<div class='bs-callout bs-callout-info fade in'>
				...
				<div class="row">
					<div class="col-sm-2">
						<label><span class='required'>*</span>分组 group:</label>
					</div>
					<div class="col-sm-4">
						<input type='text' name="group" value="${entity.group }" validation='required' data-placement='right' />
					</div>
					<div class="col-sm-2">
				...
				<div class="row">
					<div class="col-sm-2">
						<label><span class='required'>*</span>显示名称 name:</label>
					</div>
					<div class="col-sm-4">
				...
				<div class="row">
					<div class="col-sm-2">
						<label><span class='required'>*</span>注释 desc:</label>
					</div>
					<div class="col-sm-4">
						<input type='text' name="desc" value="${entity.desc }" validation='required' data-placement='right' />
					</div>
					<div class="col-sm-2">
